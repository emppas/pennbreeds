...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'pennbreedsclub.org']
...
DATABASES = {
    'default': {
        ...
        'HOST': config('DB_HOST'), #DATABASE_HOST = config('DATABASE_HOST', cast=db_url)
...
#Defaults the crispy_forms to bootstrap4
